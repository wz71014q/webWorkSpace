...
function mov(eve, posx, posy) {
  ...
  let out = document.querySelector('.ob');
  let finalLeft = _eve.clientX - posx; // out盒子左边框距离左窗口的距离
  let finalHeight = _eve.clientY - posy; // out盒子上边框距离上窗口的距离
